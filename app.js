...
(function () {
  ...
  var CHAPTERS_1010 = [
    ...
    { href: 'chapter-4.html', icon: 'fas fa-clipboard-list', title: '3. Summarizing Your Way to Synthesis', readingTime: '10 min' },
    { href: 'chapter-7.html', icon: 'fas fa-quote-left', title: '4. Quoting, Paraphrasing, and Signal Phrases', readingTime: '12 min' },
    { href: 'chapter-13.html', icon: 'fas fa-bullhorn', title: '5. Understanding Rhetoric: The Art of Persuasion', readingTime: '18 min' },
    { href: 'chapter-14.html', icon: 'fas fa-layer-group', title: '6. Values, Assumptions, and Ideology', readingTime: '14 min' },
    { href: 'chapter-3.html', icon: 'fas fa-pen-fancy', title: '7. Strategies for Getting Started', readingTime: '9 min' },
    { href: 'chapter-9.html', icon: 'fas fa-bullseye', title: '8. Crafting Powerful Thesis Statements', readingTime: '11 min' },
    { href: 'chapter-11.html', icon: 'fas fa-align-left', title: '9. Designing Effective Paragraphs', readingTime: '13 min' },
    { href: 'chapter-10.html', icon: 'fas fa-project-diagram', title: '10. Analysis and Synthesis', readingTime: '16 min' },
    { href: 'chapter-5.html', icon: 'fas fa-comments', title: '11. Argumentation: Joining the Academic Conversation', readingTime: '18 min' },
    { href: 'chapter-6.html', icon: 'fas fa-search', title: '12. Finding and Evaluating Sources', readingTime: '12 min' },
    { href: 'chapter-8.html', icon: 'fas fa-link', title: '13. Using Sources in Your Argument', readingTime: '14 min' },
    { href: 'chapter-12.html', icon: 'fas fa-pen-to-square', title: '14. Revision: From Draft to Final', readingTime: '12 min' }
  ];
